...
<head>
	...
	<title>FarmoCo portal | Admin Dashboard</title>
...
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($products);?></div>
													<div class="stat-panel-title text-uppercase">Listed Products</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-number h1 "><?php echo htmlentities($comments);?></div>
