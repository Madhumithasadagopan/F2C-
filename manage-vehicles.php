...
<head>
	...
	<title>FarmCo Portal |Admin Manage Vehicles   </title>
...
<?php $sql = "SELECT tblvehicles.ProductTitle,tblbrands.ProductName,tblvehicles.Price,tblvehicles.Location,tblvehicles.ValidDate,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.Product";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->Location);?></td>
												<td><?php echo htmlentities($result->ValidDate);?></td>
